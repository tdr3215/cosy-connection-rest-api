...
public class UserController {
    ...
    public ResponseEntity<Optional<User>> findUserByFirstName(@RequestParam(value = "firstname") String firstname) {
    ...
    public ResponseEntity<Optional<List<User>>> findUserByAge(@RequestParam(value = "min") Integer min, @RequestParam(value = "max") Integer max) {
